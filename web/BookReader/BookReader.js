...
//    var url = './AltoJAXBSearch?action=searchParam&term='+term+'&altoFilePath='+encodeURIComponent(altoFilePath);
    var url = './AltoSAXSearch?action=searchParam&term='+term+'&altoFilePath='+encodeURIComponent(filePath);
...
BookReader.prototype.menuBar = function(val){

		var self = br;
        self.updateNavPageNum(val); // hiding now but will show later
        $("#pagenum").hide();
        self.jumpToIndex(val);
        return true;
}
...
BookReader.prototype.initUIStrings = function()
{
    ...
    var titles = {'.zoom_in': title_zoom_in,
			   '.zoom_out': title_zoom_out,
			   '.onepg': title_onepg,
			   '.twopg': title_twopg,
			   '.thumb': title_thumb,
			   ...
			   '.full': title_fullscreen,
			   '.book_left': title_book_left,
			   '.book_right': title_book_right,
			   '.book_up': 'Page up',
			   '.book_down': 'Page down',
			   '.play': title_play,
			   '.pause': title_pause,
