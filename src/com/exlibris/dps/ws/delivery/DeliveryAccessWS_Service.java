    ...
    extends Service
{
    ...
    static {
        ...
        try {
            URL baseUrl;
            baseUrl = com.exlibris.dps.ws.delivery.DeliveryAccessWS_Service.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:1801/dpsws/delivery/DeliveryAccessWS?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:1801/dpsws/delivery/DeliveryAccessWS?wsdl', retrying as a local file");
    ...
    public DeliveryAccessWS_Service() {
        super(DELIVERYACCESSWS_WSDL_LOCATION, new QName("http://dps.exlibris.com/", "DeliveryAccessWS"));
    }
